...
export class Shopify {
    ...
    async query(v) {
        // let project = this.#callStackProject();
        let project = CallStack.getProject();
    ...
    #normalize(result) {
        ...
        if (targetData['edges']) {
            ...
            let cost = result.data.extensions.cost.requestedQueryCost;
            let balance = result.data.extensions.cost.throttleStatus.currentlyAvailable;
            let hasNext = result.data.data.products.pageInfo.hasNextPage
